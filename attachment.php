...
<a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php printf( esc_html__( 'Return to %s', 'stripes' ), esc_att( get_the_title( $post->post_parent ), 1 ) ); ?>" rev="attachment"><?php esc_html_e( 'Return to', 'stripes' ); ?> <?php echo get_the_title( $post->post_parent ); ?></a>
