...
<a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php printf( __( 'Return to %s', 'stripes' ), esc_html( get_the_title( $post->post_parent ), 1 ) ); ?>" rev="attachment"><?php _e( 'Return to', 'stripes' ); ?> <?php echo get_the_title( $post->post_parent ); ?></a>
